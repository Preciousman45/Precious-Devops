    ...
    <div class="main">
        ...
        <div class="book-grid">
            <?php foreach ($allBorrowedBooks as $book): ?>
                <a href="/viewBookDetails?id=<?= urlencode($book['bookId']) ?>" class="book-card">
                    ...
                    <div class="book-info">
                        ...
                        <div class="book-meta">
                            <p><strong>Borrow ID:</strong> <?= htmlspecialchars($book['borrowId']) ?></p>
                            <p><strong>Borrowed:</strong> <?= htmlspecialchars($book['borrowDate']) ?></p>
                            <p><strong>Due:</strong> <?= htmlspecialchars($book['dueDate']) ?></p>
                            <p><strong>Borrower:</strong> <?= htmlspecialchars($book['username']) ?></p>
                        </div>
                    </div>
                </a>
            <?php endforeach; ?>
            ...
            <?php if (empty($allBorrowedBooks)): ?>
                <p class="empty-msg">No borrowed books found.</p>
            <?php endif; ?>
        </div>
